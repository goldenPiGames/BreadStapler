...
function lg(name) {
	return langjson && langjson[name] || lang_en[name] || throwMaybe(name + " could not be found");
}
...
const lang_en = {
	...
	"waterend2" : "But.. how did it get here?",
	"waterend3" : "It had been isolated and contained safely in the Retum.",
